...
(() => {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    (function () {
      ...
      // Click em vídeo dentro do modal abre o video-modal (YouTube lightbox)
      const ytModal = document.querySelector('[data-video-modal]');
      const ytPlayer = ytModal?.querySelector('[data-video-player]');
      modal.querySelectorAll('[data-cm-yt]').forEach((card) => {
        card.addEventListener('click', () => {
          const id = card.getAttribute('data-cm-yt');
